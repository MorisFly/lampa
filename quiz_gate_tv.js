...
// =========================
// DESPERATE HOUSEWIVES - EASY
// =========================

{ show: 'dh', difficulty: 'easy', question: 'На какой улице происходит действие сериала?', answers: ['Wisteria Lane', 'Maple Street', 'Sunset Boulevard', 'Rosewood Drive'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'С чего начинается сериал (смерть рассказчицы)?', answers: ['Самоубийство Мэри Элис', 'Убийство Сьюзан', 'Пожар', 'Авария'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'Как зовут рыжеволосую главную героиню?', answers: ['Сьюзан Майер', 'Бри Ван де Камп', 'Габриэль Солис', 'Линетт Скаво'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'Какая героиня идеально одержима порядком и этикетом?', answers: ['Бри Ван де Камп', 'Сьюзан', 'Габриэль', 'Линетт'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'Кто бывшая модель в сериале?', answers: ['Габриэль Солис', 'Сьюзан', 'Бри', 'Эди'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'У кого много детей и хаотичная жизнь?', answers: ['Линетт Скаво', 'Бри', 'Сьюзан', 'Мэри Элис'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'Как зовут рассказчицу сериала?', answers: ['Мэри Элис Янг', 'Сьюзан', 'Габриэль', 'Бри'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'В каком жанре выполнен сериал?', answers: ['Драмеди', 'Триллер', 'Ситком', 'Фэнтези'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'Кто часто попадает в нелепые ситуации из-за любви?', answers: ['Сьюзан', 'Бри', 'Габриэль', 'Линетт'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'Кто из героинь чаще всего изменяла мужу?', answers: ['Габриэль Солис', 'Бри', 'Линетт', 'Сьюзан'], correct: 0 },

{ show: 'dh', difficulty: 'easy', question: 'Как называется улица, где живут героини?', answers: ['Wisteria Lane', 'Oak Street', 'Pine Avenue', 'Elm Street'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'Кто домохозяйка-идеалистка с кулинарным перфекционизмом?', answers: ['Бри', 'Сьюзан', 'Габриэль', 'Линетт'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'Кто из героинь дизайнер интерьеров (в начале)?', answers: ['Бри', 'Сьюзан', 'Габриэль', 'Линетт'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'Кто воспитывает много детей-близнецов?', answers: ['Линетт', 'Бри', 'Сьюзан', 'Эди'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'Кто часто становится жертвой несчастной любви?', answers: ['Сьюзан', 'Бри', 'Габриэль', 'Линетт'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'Кто самая саркастичная соседка?', answers: ['Эди Бритт', 'Сьюзан', 'Бри', 'Линетт'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'Какой основной сеттинг сериала?', answers: ['Пригородный район', 'Большой город', 'Школа', 'Больница'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'Кто бывшая топ-модель и жена богатого мужчины?', answers: ['Габриэль', 'Сьюзан', 'Бри', 'Линетт'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'Кто чаще всего контролирует семью?', answers: ['Бри', 'Сьюзан', 'Габриэль', 'Эди'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'Какой жанр ближе всего сериалу?', answers: ['Драма с элементами комедии', 'Боевик', 'Хоррор', 'Фантастика'], correct: 0 },

{ show: 'dh', difficulty: 'easy', question: 'Кто является центральной группой героинь?', answers: ['Домохозяйки Wisteria Lane', 'Полицейские', 'Учителя', 'Врачи'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'Кто часто попадает в романтические истории?', answers: ['Сьюзан', 'Бри', 'Линетт', 'Эди'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'Кто из героинь самая организованная?', answers: ['Бри', 'Сьюзан', 'Габриэль', 'Линетт'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'Кто из героинь переживает семейный хаос?', answers: ['Линетт', 'Бри', 'Сьюзан', 'Габриэль'], correct: 0 },
{ show: 'dh', difficulty: 'easy', question: 'Какой элемент есть почти в каждой серии?', answers: ['Секреты и драмы', 'Сражения', 'Космос', 'Судебные процессы'], correct: 0 },

// =========================
// DESPERATE HOUSEWIVES - MEDIUM
// =========================

{ show: 'dh', difficulty: 'medium', question: 'Кто создатель сериала?', answers: ['Марк Черри', 'Райан Мёрфи', 'Шонда Раймс', 'Аарон Соркин'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'На каком телеканале выходил сериал в США?', answers: ['ABC', 'NBC', 'CBS', 'FOX'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'Как зовут мужа Бри в начале сериала?', answers: ['Рекс Ван де Камп', 'Карл Майер', 'Карлос Солис', 'Том Скаво'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'Как зовут мужа Сьюзан?', answers: ['Карл Майер', 'Рекс', 'Карлос', 'Том'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'Как зовут мужа Габриэль?', answers: ['Карлос Солис', 'Карл Майер', 'Рекс', 'Том'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'Как зовут мужа Линетт?', answers: ['Том Скаво', 'Карлос', 'Рекс', 'Карл'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'Как называется главный таймлайн сериала?', answers: ['Wisteria Lane', 'Fairview', 'Maple Town', 'Sunnydale'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'Кто погибает в самом начале сериала?', answers: ['Мэри Элис Янг', 'Сьюзан', 'Бри', 'Эди'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'Как зовут актрису, играющую Сьюзан?', answers: ['Тери Хэтчер', 'Марсия Кросс', 'Ева Лонгория', 'Фелисити Хаффман'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'Как зовут актрису, играющую Бри?', answers: ['Марсия Кросс', 'Тери Хэтчер', 'Ева Лонгория', 'Фелисити Хаффман'], correct: 0 },

{ show: 'dh', difficulty: 'medium', question: 'Как зовут актрису, играющую Габриэль?', answers: ['Ева Лонгория', 'Марсия Кросс', 'Тери Хэтчер', 'Фелисити Хаффман'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'Как зовут актрису, играющую Линетт?', answers: ['Фелисити Хаффман', 'Ева Лонгория', 'Тери Хэтчер', 'Марсия Кросс'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'Как зовут соседку-сплетницу?', answers: ['Эди Бритт', 'Мэри Элис', 'Сьюзан', 'Бри'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'Как называется стиль повествования?', answers: ['Ненадёжный рассказчик (voice-over)', 'Документалка', 'Реалити-шоу', 'Антология'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'Кто чаще всего хранит секреты?', answers: ['Все героини', 'Только Бри', 'Только Сьюзан', 'Только Линетт'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'Как зовут сына Линетт, который болен в ранних сезонах?', answers: ['Портер/Паркеры (двойня)', 'Карл', 'Рекс', 'Майкл'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'Как называется город, где происходит действие?', answers: ['Fairview', 'Westview', 'Brookfield', 'Riverdale'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'Какой основной канал транслировал сериал?', answers: ['ABC', 'NBC', 'CBS', 'FOX'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'Кто из героинь самая богатая в начале?', answers: ['Габриэль', 'Сьюзан', 'Бри', 'Линетт'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'Кто чаще всего попадает в криминальные истории?', answers: ['Все героини', 'Только Бри', 'Только Сьюзан', 'Только Эди'], correct: 0 },

{ show: 'dh', difficulty: 'medium', question: 'Как зовут подругу, которая умерла в первой серии?', answers: ['Мэри Элис', 'Эди', 'Сьюзан', 'Бри'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'Кто известен как идеальная домохозяйка?', answers: ['Бри', 'Сьюзан', 'Габриэль', 'Линетт'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'Кто из героинь имеет модельное прошлое?', answers: ['Габриэль', 'Сьюзан', 'Бри', 'Линетт'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'Кто из героинь постоянно сталкивается с финансовыми проблемами?', answers: ['Сьюзан', 'Бри', 'Габриэль', 'Эди'], correct: 0 },
{ show: 'dh', difficulty: 'medium', question: 'Кто из героинь самая прагматичная в семье?', answers: ['Линетт', 'Сьюзан', 'Габриэль', 'Эди'], correct: 0 },

// =========================
// DESPERATE HOUSEWIVES - HARD
// =========================

{ show: 'dh', difficulty: 'hard', question: 'Кто является создателем сериала?', answers: ['Марк Черри', 'Шонда Раймс', 'Райан Мёрфи', 'Аарон Соркин'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Как называется жанр сериала точнее всего?', answers: ['Драмеди / мыльная опера с мистикой', 'Ситком', 'Процедурал', 'Фантастика'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Как зовут актрису, играющую Сьюзан Майер?', answers: ['Тери Хэтчер', 'Ева Лонгория', 'Марсия Кросс', 'Фелисити Хаффман'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Как зовут актрису, играющую Бри Ван де Камп?', answers: ['Марсия Кросс', 'Тери Хэтчер', 'Ева Лонгория', 'Фелисити Хаффман'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Как зовут актрису, играющую Габриэль Солис?', answers: ['Ева Лонгория', 'Марсия Кросс', 'Тери Хэтчер', 'Фелисити Хаффман'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Как зовут актрису, играющую Линетт Скаво?', answers: ['Фелисити Хаффман', 'Ева Лонгория', 'Тери Хэтчер', 'Марсия Кросс'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Как называется центральная улица сериала?', answers: ['Wisteria Lane', 'Fairview Street', 'Maple Lane', 'Oak Avenue'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Как зовут мужа Бри в первом сезоне?', answers: ['Рекс Ван де Камп', 'Карл Майер', 'Карлос Солис', 'Том Скаво'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Какой приём используется в сериале для повествования?', answers: ['Voice-over мёртвой героини', 'Третье лицо', 'Реалити камера', 'Флешмобы'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Как зовут создателя, известного также по другим драмеди?', answers: ['Марк Черри', 'Шонда Раймс', 'Райан Мёрфи', 'Дж. Дж. Абрамс'], correct: 0 },

{ show: 'dh', difficulty: 'hard', question: 'Как называется город действия сериала?', answers: ['Fairview', 'Westfield', 'Brookfield', 'Riverdale'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Кто из героинь является самой стабильной эмоционально?', answers: ['Линетт', 'Сьюзан', 'Габриэль', 'Бри'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Кто чаще всего скрывает преступления в сериале?', answers: ['Все главные героини', 'Только Бри', 'Только Сьюзан', 'Только Габриэль'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Как зовут подругу, чья смерть запускает сюжет?', answers: ['Мэри Элис Янг', 'Эди Бритт', 'Сьюзан', 'Бри'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Как называется стиль сериала?', answers: ['Mysterious suburban drama', 'Sitcom', 'Crime procedural', 'Fantasy drama'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Какой канал производил сериал?', answers: ['ABC', 'NBC', 'CBS', 'FOX'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Кто из героинь имеет наиболее “идеальный” фасад жизни?', answers: ['Бри', 'Сьюзан', 'Габриэль', 'Линетт'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Кто из героинь чаще всего попадает в юридические проблемы?', answers: ['Сьюзан', 'Габриэль', 'Бри', 'Линетт'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Как называется формат сериала по структуре сезонов?', answers: ['Мыльная опера с сезонными тайнами', 'Антология', 'Процедурал', 'Ситком'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Как зовут актрису, играющую Эди Бритт?', answers: ['Николетт Шеридан', 'Ева Лонгория', 'Марсия Кросс', 'Тери Хэтчер'], correct: 0 },

{ show: 'dh', difficulty: 'hard', question: 'Как называется основной нарративный приём сериала?', answers: ['Секреты и тайны пригорода', 'Полицейские расследования', 'Фантастические элементы', 'Судебные драмы'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Кто из героинь чаще всего оказывается в центре интриг?', answers: ['Все главные героини', 'Только Бри', 'Только Сьюзан', 'Только Габриэль'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Как зовут мужа Габриэль?', answers: ['Карлос Солис', 'Карл Майер', 'Рекс', 'Том'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Как зовут мужа Линетт?', answers: ['Том Скаво', 'Карлос', 'Рекс', 'Карл'], correct: 0 },
{ show: 'dh', difficulty: 'hard', question: 'Как называется ключевая тема сериала?', answers: ['Секреты пригородной жизни', 'Криминальные расследования', 'Фантастика', 'Политика'], correct: 0 }
    ...
    function registerTvController() {
        Lampa.Controller.add('quiz_gate', {
            ...
            back: function () {
                ...
                if (backBtn.length) backBtn.click();
            }
        });
    ...
    function applyTvFocus() {
        $('#quiz-gate-content .quiz-focusable').removeClass('focus');
    ...
    function renderIntroScreen() {
        $('#quiz-gate-content').html(`
            <h2>Вход ограничен! 🛑</h2>
            <p>Пройдите квиз, чтобы получить доступ.</p>

            <button class="quiz-btn primary-btn quiz-focusable init-start">
                Начать
            </button>
        `);

        $('.init-start').on('click', renderThemeScreen);
    ...
    function renderThemeScreen() {
        $('#quiz-gate-content').html(`
            <h2>Выберите сериал</h2>

            <div class="quiz-options-list">
                <button class="quiz-btn quiz-focusable select-theme" data-theme="tbbt">TBBT</button>
                <button class="quiz-btn quiz-focusable select-theme" data-theme="office">Office (US)</button>
                <button class="quiz-btn quiz-focusable select-theme" data-theme="housewives">Desperate Housewives</button>
                <button class="quiz-btn quiz-focusable select-theme" data-theme="b99">Brooklyn 99</button>
            </div>
        `);
    ...
    function renderDifficultyScreen() {
        $('#quiz-gate-content').html(`
            ...
            <div class="quiz-options-list">
                <button class="quiz-btn quiz-focusable select-diff" data-diff="easy">Легко</button>
                <button class="quiz-btn quiz-focusable select-diff" data-diff="medium">Средне</button>
                <button class="quiz-btn quiz-focusable select-diff" data-diff="hard">Сложно</button>

                <button class="quiz-btn link-btn quiz-focusable back-to-start">
                    ↩ Назад
                </button>
            </div>
        `);
        ...
        $('.back-to-start').on('click', renderThemeScreen);
    ...
    function startQuizLogic() {
        let pool = QUESTIONS_BASE.filter(q =>
            q.show === gameState.selectedShow &&
            q.difficulty === gameState.selectedDifficulty
        );

        if (pool.length < QUESTIONS_PER_GAME) {
            pool = QUESTIONS_BASE.filter(q =>
                q.show === gameState.selectedShow
            );
        }

        gameState.quizQuestions = shuffle(pool).slice(0, QUESTIONS_PER_GAME);
    ...
    function renderQuestionScreen() {
        const q = gameState.quizQuestions[gameState.currentIndex];
        ...
        q.answers.forEach((a, i) => {
            answersHtml += `
                <button class="quiz-btn answer-btn quiz-focusable select-answer" data-idx="${i}">
                    ${a}
                </button>
            `;
        });
        ...
        $('#quiz-gate-content').html(`
            <div class="quiz-header-nav">
                ...
                <span>
                    ${gameState.currentIndex + 1} / ${gameState.quizQuestions.length}
                </span>
            </div>
            ...
            <div class="quiz-live-score">
                <span>✔ ${gameState.correctCount}</span>
                <span>✖ ${gameState.incorrectCount}</span>
            </div>
        `);
        ...
        $('.select-answer').on('click', function () {
            ...
            const chosen = +$(this).data('idx');
            const correct = q.correct;

            $('.select-answer').each(function (i) {
                if (i === correct) $(this).addClass('btn-correct');
                if (i === chosen && chosen !== correct) $(this).addClass('btn-incorrect');
            });

            if (chosen === correct) gameState.correctCount++;
            else gameState.incorrectCount++;

            setTimeout(() => {
                gameState.currentIndex++;

                if (gameState.currentIndex >= gameState.quizQuestions.length) {
                    renderFinalResultScreen();
                } else {
                    renderQuestionScreen();
                }
    ...
    function renderFinalResultScreen() {
        const pass = gameState.correctCount >= Math.ceil(QUESTIONS_PER_GAME * 0.6);

        $('#quiz-gate-content').html(`
            <h2>${pass ? 'Успех 🎉' : 'Провал 💀'}</h2>

            <p>Результат: ${gameState.correctCount} / ${gameState.quizQuestions.length}</p>

            <button class="quiz-btn quiz-focusable restart">
                Попробовать снова
            </button>
        `);

        $('.restart').on('click', renderThemeScreen);
    ...
    function injectStyles() {
        $('<style>').text(`
            ...
            .btn-correct { background: green !important; }
            .btn-incorrect { background: red !important; }
        `).appendTo('head');
    }
